...
rule polish_extract_haplotype_reads:
	...
	output:
		...
		split = "{results}/polishing/{callset}/all/haplotag/split_{sample}_{haplotype}_{chrom}.bam",
...
rule polish_detect_errors:
	...
	output:
		vcf = "{results}/polishing/{callset}/all/errors/errors_{sample}_{haplotype}_{chrom}_{windowsize}.vcf.gz",
...
rule polish_correct_errors:
	...
	input:
		...
		haplotype = "{results}/polishing/{callset}/consensus/{sample}_{haplotype}.fa"
	output:
		"{results}/polishing/{callset}/all/polished/{sample}_{haplotype}_{windowsize}.fa"
	log:
